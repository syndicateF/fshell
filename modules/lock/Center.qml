...
ColumnLayout {
    ...
    readonly property list<string> timeComponents: Time.format(Config.services.useTwelveHourClock ? "hh:mm" : "HH:mm").split(":")
    ...
    Item {
        ...
        ColumnLayout {
            ...
            StyledText {
                ...
                font.pointSize: Math.floor(Appearance.font.size.large * root.centerScale)
    ...
    // Spacer between clock and login
    Item {
        Layout.fillHeight: true
        Layout.minimumHeight: Appearance.spacing.large
    }
    ...
    Item {
        ...
        ColumnLayout {
            ...
            // Messages (centered, between avatar and bottom)
            Item {
